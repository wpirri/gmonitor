...
public:
	...
	const char* Crc();
	/* Tama�o del bloque de datos contenido en este mensaje */
	...
	/* Tama�o maximo del mensaje a transferir dterminado por el cliente
	...
	/* Tama�o total del mensaje, salvo para los interactivos debe ser
	igual a TamMensaje */
